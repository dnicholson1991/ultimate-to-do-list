...
public class PureCalendarReceiver extends BroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		{
			Util.log("PureCalendarReceiver got a bad URI: "+intent.getDataString());
			return;
		}
		String action = intent.getAction();
		if (action==null)
		{
			Util.log("PureCalendarReceiver got a null action.");
			return;
		}
    	...
    	{
    		Util.log("PureCalendarReceiver got bad action: "+action);
    		return;
    	}
	}
