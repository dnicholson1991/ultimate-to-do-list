...
public class EditFolderActivity extends UtlActivity
{
	private EditFolderFragment _editFragment;
    ...
    protected void onPostCreate(Bundle savedInstanceState)
	{
		...
		EditFolderFragment existing = (EditFolderFragment)fragmentManager.findFragmentByTag(
